...
-- Membuang data untuk tabel praktikum_presensi_penggajian.bagian: ~3 rows (lebih kurang)
...
-- Membuang data untuk tabel praktikum_presensi_penggajian.bagian_karyawan: ~6 rows (lebih kurang)
...
-- Membuang data untuk tabel praktikum_presensi_penggajian.jabatan: ~9 rows (lebih kurang)
...
INSERT INTO `jabatan` (`id`, `nama_jabatan`, `gapok_jabatan`, `tunjangan_jabatan`, `uang_makan_perhari`) VALUES
	...
	(8, 'UI/UX', 80000000, 500000, 20000),
	(9, 'Junior Designer', 3500000, 500000, 50000);
...
-- Membuang data untuk tabel praktikum_presensi_penggajian.karyawan: ~10 rows (lebih kurang)
...
INSERT INTO `karyawan` (`id`, `nik`, `nama_lengkap`, `handphone`, `email`, `tanggal_masuk`, `pengguna_id`) VALUES
	...
	(9, '18631134', 'Ridho', '08213xxxxxxx', 'ridho@ridho.com', '2022-02-14', 9);
/*!40000 ALTER TABLE `karyawan` ENABLE KEYS */;

-- Membuang data untuk tabel praktikum_presensi_penggajian.lokasi: ~9 rows (lebih kurang)
...
-- Membuang data untuk tabel praktikum_presensi_penggajian.penggajian: ~18 rows (lebih kurang)
...
-- Membuang data untuk tabel praktikum_presensi_penggajian.pengguna: ~10 rows (lebih kurang)
...
INSERT INTO `pengguna` (`id`, `username`, `password`, `peran`, `login_terakhir`) VALUES
	...
	(9, 'rdhoanshr', '57075e3e6381fd2cb35aa22dee25977b', 'ADMIN', NULL);
/*!40000 ALTER TABLE `pengguna` ENABLE KEYS */;

-- Membuang data untuk tabel praktikum_presensi_penggajian.presensi: ~552 rows (lebih kurang)
