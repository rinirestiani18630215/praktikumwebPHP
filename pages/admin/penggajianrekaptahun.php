            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><?php echo $tahun ?></li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <div class="content">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Data Rekap Gaji Tahun <?php echo $tahun ?></h3>
                <a href="export/penggajianrekaptahun-pdf.php?tahun=<?php echo $tahun ?>" target="blank" class="btn btn-success btn-sm float-right">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="?page=penggajianrekapbulan&tahun=<?php echo $tahun ?>&bulan=<?php echo $row['bulan'] ?>" class="btn btn-info btn-sm mr-1"><i class="fa fa-info"></i> Rincian</a>
                                </td>
                            </tr>
                        <?php
                        }
