...
?>
        ...
        <?php
                ...
                $updateSql = "UPDATE bagian SET nama_bagian = :nama,
                                karyawan_id = :karyawan,
                                lokasi_id = :lokasi
                                WHERE id = :id";
                $stmt = $db->prepare($updateSql);
                $stmt->bindParam(':nama', $_POST['nama_bagian']);
                $stmt->bindParam(':karyawan', $_POST['karyawan_id']);
                $stmt->bindParam(':lokasi', $_POST['lokasi_id']);
